...
.venv\Scripts\pyinstaller.exe --noconfirm --onefile --windowed --icon="ai_assistant.ico" --add-data="ai_assistant.ico;." --add-data="webview_app\ai_tester_frontend;webview_app\ai_tester_frontend" --name "KLineTrainer_AI_Assistant" ai_assistant_tester.py
